...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Award', 'model/EliminationAlliance', 'model/Event', 'model/EventDistrictPoints', 'model/EventInsights', 'model/EventOPRs', 'model/EventRanking', 'model/EventSimple', 'model/Match', 'model/MatchSimple', 'model/Team', 'model/TeamEventStatus', 'model/TeamSimple'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Award'), require('../model/EliminationAlliance'), require('../model/Event'), require('../model/EventDistrictPoints'), require('../model/EventInsights'), require('../model/EventOPRs'), require('../model/EventRanking'), require('../model/EventSimple'), require('../model/Match'), require('../model/MatchSimple'), require('../model/Team'), require('../model/TeamEventStatus'), require('../model/TeamSimple'));
  } else {
    // Browser globals (root is window)
    if (!root.TbaApiV3client) {
      root.TbaApiV3client = {};
    }
    root.TbaApiV3client.EventApi = factory(root.TbaApiV3client.ApiClient, root.TbaApiV3client.Award, root.TbaApiV3client.EliminationAlliance, root.TbaApiV3client.Event, root.TbaApiV3client.EventDistrictPoints, root.TbaApiV3client.EventInsights, root.TbaApiV3client.EventOPRs, root.TbaApiV3client.EventRanking, root.TbaApiV3client.EventSimple, root.TbaApiV3client.Match, root.TbaApiV3client.MatchSimple, root.TbaApiV3client.Team, root.TbaApiV3client.TeamEventStatus, root.TbaApiV3client.TeamSimple);
  }
}(this, function(ApiClient, Award, EliminationAlliance, Event, EventDistrictPoints, EventInsights, EventOPRs, EventRanking, EventSimple, Match, MatchSimple, Team, TeamEventStatus, TeamSimple) {
  'use strict';
