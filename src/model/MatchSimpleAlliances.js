...
class MatchSimpleAlliances {
    ...
    constructor() { 
        ...
        MatchSimpleAlliances.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MatchSimpleAlliances();
 ...
 */
MatchSimpleAlliances.prototype['red'] = undefined;

/**
 * @member {module:model/MatchAlliance} blue
 */
MatchSimpleAlliances.prototype['blue'] = undefined;
...
export default MatchSimpleAlliances;
