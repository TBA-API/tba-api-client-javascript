...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TbaApiV3client.MatchScoreBreakdown2019();
  });
  ...
  describe('MatchScoreBreakdown2019', function() {
    it('should create an instance of MatchScoreBreakdown2019', function() {
      // uncomment below and update the code to test MatchScoreBreakdown2019
      //var instane = new TbaApiV3client.MatchScoreBreakdown2019();
      //expect(instance).to.be.a(TbaApiV3client.MatchScoreBreakdown2019);
    });
